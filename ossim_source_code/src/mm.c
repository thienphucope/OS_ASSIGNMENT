...
int init_mm(struct mm_struct *mm, struct pcb_t *caller)
{
    ...
    struct vm_rg_struct *first_rg0 = init_vm_rg(vma0->vm_start, vma0->vm_end + PAGING_PAGESZ*2, vma0->vm_id);
  ...
  // enlist_vm_rg_node(&vma1->vm_freerg_list,...)
    ...
    struct vm_rg_struct *first_rg1 = init_vm_rg(vma1->vm_end - PAGING_PAGESZ*2, vma1->vm_start, vma1->vm_id); // end to start
